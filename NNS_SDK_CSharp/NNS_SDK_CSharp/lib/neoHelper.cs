...
namespace NEL
{
    static public class neoHelper
    {
        ...
        public static long fixedPrecision(decimal num, int precision)
        {
            return (long)(num * (decimal)Math.Pow(10, precision));
        }

        public static byte[] Hexstring2Bytes(this string hexStr)
        {
            try
            {
                ...
                {
                    b[i] = byte.Parse(hexStr.Substring(i * 2, 2), System.Globalization.NumberStyles.HexNumber);
                }
                return b;
            }
            catch (Exception ex)
        ...
        public static decimal Hexstring2Decimal(this string hexStr,int decimals) {
